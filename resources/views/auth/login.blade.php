    ...
    <style>
        ...
        *,:after,:before{box-sizing:border-box}
        ...
        .login-wrap{
            ...
            min-height:670px;
            position:relative;
            background:url({{asset('images/q.jpg')}}) no-repeat center;
        ...
        <div class="login-form">
            <div class="sign-in-htm">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="group">
                        <x-label for="password" class="label" value="{{ __('Password') }}" />
            ...
            <div class="sign-up-htm">
                <form method="POST" action="{{ route('register') }}">
                    @csrf
                <div class="group">
                    <x-label for="name" class="label" value="{{ __('Name') }}" />
                ...
                <div class="group">
                    ...
                    <div class="group">
                        <x-label for="password_confirmation"  class="label" value="{{ __('Confirm Password') }}" />
                ...
                <div class="group">
                    <x-label for="phoneNumber"  class="label" value="{{ __('Phone Number') }}" />
                    <x-input id="phoneNumber" class="input" type="Number" name="phoneNumber" required autocomplete="phoneNumber" />
