...
.hero {
 background: url({{asset('images/ccc.jpg')}});
  position: relative;
  display: flex;
  align-items: center;
...
<section class="hero">
  ...
  <button>
  <a href="{{url('/buyRequest')}}" style="text-decoration: none; color: inherit;">Submit Request</a>
</button>
...
<div class="container">
      <div class="box">
        <div class="top">
          <img src="{{asset('images/ap1.jpg')}}" alt="" />
          <span
            ><i class="fas fa-heart"></i><i class="fas fa-exchange-alt"></i
          ></span>
        </div>
        <div class="bottom">
          <h3> Villa In Pyramids Heights</h3>
          <p>
           Buy your villa and enjoy the view of the pyramid, Cairo Alexandria Desert Road
          </p>
          <div class="advants">
            <div>
              <span>Bedrooms</span>
            ...
            <div>
              ...
              <div>
                ...
                ><span>2,799<span>Sq Ft</span></span>
              </div>
            </div>
          </div>
          <div class="price">
            <span>For Sale</span>
            <span>10,200,000 EGP</span>
          </div>
        </div>
      </div>
      <div class="box">
        ...
        <div class="bottom">
          <h3>Apartment In Zed East</h3>
          <p>
            Apartment 137 m underprice market in ora zed east, 5TH Settlement Compounds.
          </p>
          <div class="advants">
            <div>
              <span>Bedrooms</span>
            ...
            <div>
              ...
              <div>
                <i class="fas fa-vector-square"></i
                ><span>1,475<span>Sq Ft</span></span>
              </div>
            </div>
          </div>
          <div class="price">
            <span>For Sale</span>
            <span>2,200,000 EGP</span>
          </div>
        </div>
      </div>
      <div class="box">
        ...
        <div class="bottom">
          <h3>Apartment In Regents Park</h3>
          <p>
            Fully Finished Apartment in Regents Park, Al Andalus District
          </p>
          <div class="advants">
            <div>
              <span>Bedrooms</span>
            ...
            <div>
              ...
              <div>
                <i class="fas fa-vector-square"></i
                ><span>1,507<span>Sq Ft</span></span>
              </div>
            </div>
          </div>
          <div class="price">
            <span>For Sale</span>
            <span>8,750,000 EGP</span>
          </div>
        </div>
      </div>
    </div>
