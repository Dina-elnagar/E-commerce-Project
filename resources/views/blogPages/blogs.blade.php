...
#technology {
  background-image: url({{asset('images/pppp.jpg')}});
}
...
<div class="container">
  <div id="marketing" class="section">
    <div class="content">
      <h1><a href="{{url('/whatsNew')}}">Whats New</a></h1>
    </div>
    <div class="overlay"></div>
  </div>
  <div id="technology" class="section">
    <div class="content">
     <h1><a href="{{url('/topPicks')}}">Top Picks</a></h1>
    </div>
    <div class="overlay"></div>
  </div>
  <div id="advertising" class="section">
    <div class="content">
      <h1><a href="{{url('/article')}}">Articles</a></h1>
    </div>
    <div class="overlay"></div>
  </div>
</div>
